...
76-81 テーブルを全て 0 で埋める。

84-88 ナップザックに入り切らない場合は前の値を引き継ぐ

89-101 ナップザックに入り切る場合はカロリーが高くなる組み合わせに入れ替える。

103 最大カロリーを出力する。

106-115 history テーブルを後ろからたどり、メニューを表示する。



## 出力結果
文字化けの改善も試したがうまくいかなかった
```
$ ./k06
Max calorie: 1796
"ラージライス"
